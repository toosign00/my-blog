...
const BACK_BUTTON_CLASS =
  'theme-color-opacity-transition focus-ring center-y h3 w-fit cursor-pointer select-none gap-2 py-1.25 pr-2.25 text-gray-accent opacity-100 hover:opacity-70';
