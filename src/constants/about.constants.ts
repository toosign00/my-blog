  ...
  workExperience: [
    {
      ...
      description: [
        {
          title: 'IoT 서비스 테스트 설계 및 검증',
          items: [
            'IoT 앱, 디바이스, 클라우드 기반 테스트 시나리오 및 테스트 케이스 설계',
            '디바이스 등록, 제어, 상태 동기화 등 주요 연동 기능에 대한 E2E 및 Exploratory 테스트 수행',
            '다양한 디바이스, OS, 네트워크 환경에서 호환성과 서비스 안정성 검증',
          ],
        },
        {
          title: '회귀 테스트 및 품질 관리',
          items: [
            '개발팀과 변경 영향도를 파악하고 리스크 기반으로 회귀 범위를 선별하여 Integration, Regression, Smoke 테스트 수행',
            'Jira를 활용한 버그 리포트 작성 및 이슈 진행 상황 추적 관리',
            '테스트 결과를 바탕으로 품질 리포트를 작성하고 주요 결함과 잔여 리스크 공유',
          ],
        },
      ],
    },
      ...
      description: [
        {
          title: 'IoT 연동 기능 테스트',
          items: [
            '단위 기능, E2E, Regression, Exploratory 테스트 수행 및 결과 정리',
            '디바이스 등록, 제어, 상태 동기화 등 주요 연동 기능과 네트워크 환경별 테스트 지원',
          ],
        },
        {
          title: '버그 리포트 및 이슈 관리',
          items: [
            'Jira를 활용한 버그 리포트 등록 및 이슈 진행 상황 관리 지원',
            '수정 사항에 대한 재검증 수행 및 결과 공유',
          ],
        },
      ],
    },
